...
variable "eks_endpoint_public_access_cidrs" {
  type        = list(string)
  description = "Public CIDRs allowed to reach the EKS API. Use trusted CIDRs for a real production environment; this learning account uses 0.0.0.0/0 because the administrator ISP address changes."
}
